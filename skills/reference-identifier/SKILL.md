...
This will launch the **reference identifier** agent, which reads your notebook summary and paper composition, then uses web search to identify and verify 15–25 key references the paper should engage with. The result is written to `pipeline/key_references.md`.
